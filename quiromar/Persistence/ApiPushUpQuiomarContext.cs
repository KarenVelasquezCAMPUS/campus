...
{
    public class ApiPushUpQuiomarContext : DbContext
    {
        public ApiPushUpQuiomarContext(DbContextOptions<ApiPushUpQuiomarContext> options) : base(options)
        { 
        }
        public DbSet<Cargo> Cargos { get; set; }
        public DbSet<Cliente> Clientes { get; set; }
        public DbSet<Couleur> Couleures { get; set; }
